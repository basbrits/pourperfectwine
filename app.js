(function () {
  ...
  var VERSION = "strict-recognition-v1";
  ...
  function evaluateFingerprint(fingerprint, sourceLabel) {
    ...
    if (best.score >= threshold) {
      ...
      setStatus("Not recognized. Best match was " + best.artwork.title + " at only " + percent + "%. Try a clearer, straighter photo of the painting.", "error");
      log("Recognition rejected. No artwork opened because score was below threshold.");
    }
  }
